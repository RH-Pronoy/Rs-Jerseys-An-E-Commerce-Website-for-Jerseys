...
if ($product_id > 0) {
    ...
    $sql = "SELECT * FROM arrivals WHERE id = ?";
        ...
        <div class="container">
            ...
            <div class="product-info">
                ...
                <div class="product-details">
                    ...
                    <p>* <?php echo htmlspecialchars($row['stock_status']); ?> *</p>
                    <?php if ($row['stock_status'] != 'OUT OF STOCK'): ?>
                        <button class="add-to-cart-btn" onclick="addToCart('product<?php echo $row['id']; ?>')">Add to Cart</button>
                    <?php endif; ?>
                </div>
            </div>
