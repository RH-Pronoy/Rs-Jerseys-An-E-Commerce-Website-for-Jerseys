...
$sql1 = "SELECT * FROM national";
$result1 = $conn->query($sql1);

?>
        <section class="banner">
            <img src="WhatsApp Image 2024-06-06 at 12.30.09 AM.jpeg" alt="Promotional Banner" width="450" height="100">
          </section>
            ...
            while($row = $result1->fetch_assoc()) {
              ...
              echo '<img src="' . $row['image'] . '" alt="' . $row['name'] . '" onclick="showImage(\'' . $row['image'] . '\')">';
                ...
                if($row['stock_status'] == 'OUT OF STOCK'){
                  ...
                  echo '<button class="details-btn" onclick="openDetailsPage(\'productdetails5.php?id=' . $row['id'] . '\')">Details </button>';
